...
elefanttimarssi = pyglet.media.load("resources/audio/elefanttimarssi.wav", streaming=False)
theme = pyglet.media.load("resources/audio/elefanttimarssi.wav", streaming=False)
# fx_snake_death = ...
